...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculator (Integer cal){
        if (!num1.toString().equals("")) {
            switch (cal){
                case 1: res = (Double)res + Double.parseDouble(num1); break;
                case 2: res = (Double)res - Double.parseDouble(num1); break;
                case 3: res = (Double)res * Double.parseDouble(num1); break;
                case 4: res = (Double)res / Double.parseDouble(num1); break;
            }
            resultTextView();
            num1="";
        } else if (num1.toString().equals("")) {
            toastDisplay("숫자 적어주세요~");
        } else {
    ...
    public void resultTextView(){
        txtview.setText("결과 : " + Math.round(res*100)/100.0);
    }
}
