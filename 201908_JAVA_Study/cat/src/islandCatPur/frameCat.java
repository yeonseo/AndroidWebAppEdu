...
public class frameCat extends JFrame {
	...
	private JPanel commendPanel = new JPanel();
	private JLabel commendLabel = new JLabel();
	...
	private static int titleW = 200;
	private static int titleH = 100;
	private static int titleX = (Main.SCREEN_WIDTH - titleW);
	private static int titleY= (Main.SCREEN_HEIGHT - titleH);
	...
	public frameCat() {
		...
		feedButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String inLine = String.valueOf(i);
				if (inLine != null) {
					commendPanel.setBounds(titleX, titleY, titleW/4, titleH/4);
					commendPanel.setBackground(new Color(0,0,0,0));
					commendPanel.setVisible(false);
					commendLabel = new JLabel(inLine);
					commendLabel.setForeground(Color.WHITE);
					commendPanel.add(commendLabel);
					add(commendPanel);
				}
			}
		});
		...
		feedTitlePanel.setBounds(titleX, titleY, (titleW/2) , (titleH/4) );
